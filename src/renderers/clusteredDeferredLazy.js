...
export default class ClusteredDeferredRendererLazy extends ClusteredRenderer {
  ...
  render(camera, scene) {
    ...
    // TODO: Bind any other shader inputs
    // bind u_dims
    gl.uniform4fv(this._progShade.u_dims, vec4.fromValues(canvas.width, canvas.height, Math.log(camera.near), Math.log(camera.far) - Math.log(camera.near)));
