...
export default class ClusteredDeferredRenderer extends ClusteredRenderer {
  constructor(xSlices, ySlices, zSlices) {
    ...
    this._progShade = loadShaderProgram(QuadVertSource, fsSource({
      ...
      uniforms: ['u_viewMatrix', 'u_gbuffers[0]', 'u_gbuffers[1]', 'u_lightbuffer', 'u_clusterbuffer',
  ...
  render(camera, scene) {
    ...
    gl.uniform1f(this._progShade.u_tanfov2, Math.abs(Math.tan(camera.fov * 0.5 * Math.PI / 180.0)));
