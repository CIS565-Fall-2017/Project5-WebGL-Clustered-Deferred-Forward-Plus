...
export default class ClusteredDeferredRenderer extends ClusteredRenderer {
  constructor(xSlices, ySlices, zSlices) {
    ...
    this._progShade = loadShaderProgram(QuadVertSource, fsSource({
      ...
      uniforms: ['u_gbuffers[0]', 'u_gbuffers[1]', 'u_gbuffers[2]', 'u_gbuffers[3]','u_clusterbuffer', 
      'u_lightbuffer', 'u_depthBuffer', 'u_cameraInfo', 'u_viewMatrix'],
  ...
  render(camera, scene) {
    ...
    //Camera info
    gl.uniform4f(this._progShade.u_cameraInfo, canvas.width, canvas.height, camera.near, camera.far);
    //view Matrix
